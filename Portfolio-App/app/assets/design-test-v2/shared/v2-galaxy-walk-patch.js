...
(function () {
  ...
  function injectLayoutCss() {
    ...
    style.textContent = [
      ...
      "    width: min(252px, 19.5vw) !important;",
      "    max-width: min(252px, 19.5vw) !important;",
      ...
      "    max-width: min(11vw, 150px) !important;",
      ...
      "  }",
      "  /* Multiversum Profil: etwas mehr Kopfraum — Gesicht nicht oben abschneiden */",
      ...
      "  html body .overview-intro-box {",
      "    width: min(242px, 19.5vw) !important;",
      "    max-width: min(242px, 19.5vw) !important;",
      "    padding: 8px 9px !important;",
      "  }",
      "  html body .live-textbox,",
      "  html body .final-textbox {",
      "    width: min(10.2vw, 136px) !important;",
      "    max-width: min(10.2vw, 136px) !important;",
      ...
      "  html body .overview-intro-box {",
      "    width: min(224px, 19vw) !important;",
      "    max-width: min(224px, 19vw) !important;",
      "    padding: 7px 8px !important;",
      "  }",
      "  html body .live-textbox {",
      "    width: min(9.6vw, 126px) !important;",
      "    max-width: min(9.6vw, 126px) !important;",
      "  }",
      ...
      "  }",
      "  html body .overview-intro-box {",
      "    width: min(280px, 16.5vw) !important;",
      "    max-width: min(280px, 16.5vw) !important;",
      "  }",
      "  html body .live-textbox,",
      "  html body .final-textbox {",
      "    width: min(9.2vw, 154px) !important;",
      "    max-width: min(9.2vw, 154px) !important;",
      "  }",
