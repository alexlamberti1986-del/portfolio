...
(function () {
  ...
  /** Readable short copy for the 5 main textboxes (overview + 4 worlds). */
  var BOX_COPY = {
    overview: {
      eyebrow: "Reisebeginn",
      title: "Reise durchs Multiversum",
      text: "Scrollen startet den Flug durch die vier Welten.",
      small: "Jede Welt mit eigener Rolle und Wirkung.",
    },
    multiversum: {
      eyebrow: "KOSMISCHES ZENTRUM",
      title: "Alle Ebenen verbunden.",
      text: "Hier treffen Persönlichkeit, Vision, Projekte und Wirkung zusammen.",
      cta: "Zur Übersicht",
    },
    nexora: {
      eyebrow: "TECH · KI · SYSTEME",
      title: "Systeme mit Zukunft.",
      text: "Technologie, KI und Automationen — präzise und elektrisch.",
      cta: "Nexora öffnen",
    },
    professional: {
      eyebrow: "KLAR · STRATEGISCH",
      title: "Struktur und Wirkung.",
      text: "Positionierung, Strategie und seriöser Auftritt mit starker Wirkung.",
      cta: "Professional ansehen",
    },
    freiraum: {
      eyebrow: "KREATIV · FREI",
      title: "Raum für Ideen.",
      text: "Warm, mutig und künstlerisch — Freiheit, Dinge anders zu sehen.",
      cta: "Freiraum entdecken",
    },
  };
  ...
  function injectLayoutCss() {
    ...
    style.textContent = [
      ...
      "  /* —— Overview (4 Welten): lesbare Intro-Box, Orbs frei —— */",
      ...
      "    max-width: min(16vw, 220px) !important;",
      ...
      "  }",
      "  /* Multiversum Profil: Gesicht mittig-oben, nicht nur Stirn */",
      "  html body .world-panel[data-world='multiversum'] a.subpage-card.subpage-1 img,",
      "  html body .world-panel[data-world='multiversum'] a.subpage-card.subpage-1:link img,",
      "  html body .world-panel[data-world='multiversum'] a.subpage-card.subpage-1:visited img,",
      "  html body .next-final-buttons a[data-alex-route='multiversum.ueber-mich'] img,",
      "  html body .next-final-buttons a[data-v2-world='multiversum'][data-v2-page='ueber-mich'] img,",
      "  html body .next-final-buttons a:nth-child(3) img {",
      ...
      "      transform: scale(1.06) !important;",
      "    }",
      "    html body .world-panel[data-world='multiversum'].is-active a.subpage-card.subpage-1:hover img {",
      "      object-position: center 28% !important;",
      "    }",
      "    html body .next-final-buttons a:nth-child(3):hover img {",
      "      object-position: center 28% !important;",
      "      transform: none !important;",
      "    }",
      ...
      "    max-width: min(250px, 24vw) !important;",
      "    padding: 10px 12px !important;",
      "  }",
      "  html body .live-textbox,",
      "  html body .final-textbox {",
      "    width: min(18vw, 200px) !important;",
      "    max-width: min(18vw, 200px) !important;",
      "    padding: 9px 10px !important;",
      "  }",
      "  html body .live-textbox p:not(.world-eyebrow) { -webkit-line-clamp: 3 !important; }",
      "  html body .subpage-card { width: clamp(96px, 11vw, 160px) !important; }",
      "  html body .world-panel[data-world='professional'] { --box-x: 17% !important; }",
      "  html body .world-panel[data-world='freiraum'] { --box-x: 17% !important; }",
      "  html body .world-panel[data-world='multiversum'] { --box-x: 83% !important; }",
      "  html body .world-panel[data-world='nexora'] { --box-x: 83% !important; }",
      "}",
      "",
      ...
      "    max-width: min(236px, 22vw) !important;",
      "    padding: 8px 10px !important;",
      "  }",
      "  html body .live-textbox {",
      "    width: min(15vw, 190px) !important;",
      "    max-width: min(15vw, 190px) !important;",
      "  }",
      "  html body .live-textbox h2 { font-size: clamp(13px, 1.6vh, 17px) !important; }",
      "  html body .live-textbox p:not(.world-eyebrow) {",
      ...
      "  }",
      "  html body .overview-intro-box {",
      "    width: min(300px, 16vw) !important;",
      "    max-width: min(300px, 16vw) !important;",
      "  }",
      "  html body .live-textbox,",
      "  html body .final-textbox {",
      "    width: min(12vw, 240px) !important;",
      "    max-width: min(12vw, 240px) !important;",
      "  }",
