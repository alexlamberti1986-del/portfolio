...
(function () {
  ...
  function injectLayoutCss() {
    ...
    style.textContent = [
      ...
      "    width: min(268px, 21vw) !important;",
      "    max-width: min(268px, 21vw) !important;",
      ...
      "    width: min(12.2vw, 166px) !important;",
      "    max-width: min(12.2vw, 166px) !important;",
      ...
      "  html body .overview-intro-box {",
      "    width: min(258px, 21vw) !important;",
      "    max-width: min(258px, 21vw) !important;",
      "    padding: 9px 10px !important;",
      "  }",
      "  html body .live-textbox,",
      "  html body .final-textbox {",
      "    width: min(11.4vw, 150px) !important;",
      "    max-width: min(11.4vw, 150px) !important;",
      ...
      "  html body .overview-intro-box {",
      "    width: min(240px, 21vw) !important;",
      "    max-width: min(240px, 21vw) !important;",
      "    padding: 8px 9px !important;",
      "  }",
      "  html body .live-textbox {",
      "    width: min(10.6vw, 140px) !important;",
      "    max-width: min(10.6vw, 140px) !important;",
      "  }",
      ...
      "  html body .live-textbox,",
      "  html body .final-textbox {",
      "    width: min(10.2vw, 170px) !important;",
      "    max-width: min(10.2vw, 170px) !important;",
      "  }",
