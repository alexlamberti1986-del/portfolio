...
(function () {
  ...
  function onSwitchStart(targetWorld) {
    ...
    hardStopBgm();
    stopIframeWorldBgm();
    /* Zus�tzliche Absicherung: Early-BGM-Element explizit stumm/pausiert,
    ...
    /* Nur Gesture-Boot f�r echten Erstbesuch erlauben � nach Wechsel starten wir �ber switch-end. */
    initialBootDone = true;
    bootGesturePending = false;
    unhookBootGesture();
    if (pendingWorld) preloadTrack(pendingWorld);
    /* User-Gesture: n�chsten Welt-Track stumm primen, damit Unmute nach Animation zuverl�ssiger greift */
